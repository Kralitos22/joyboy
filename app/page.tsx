            ...
            <div className="about-text">
              ...
              <div className="about-links-box">
                ...
                <div className="about-links-row">
                  ...
                  <a href="https://discord.gg/c2qEtDv9gZ" target="_blank" rel="noopener noreferrer" className="alink discord">💬 Discord</a>
      ...
      <section id="community" className="section community-section">
        <div className="container">
          ...
          <div className="social-grid">
            ...
            <a href="https://discord.gg/c2qEtDv9gZ" target="_blank" rel="noopener noreferrer" className="social-card discord">
              <div className="social-icon">💬</div>
              <h3>Discord</h3>
